...
namespace AcBlog.UI.Components.Bootstrap
{
    public class BootstrapUIComponent : UIComponent
    {
        public BootstrapUIComponent()
        {
            ...
            // AddStyleSheetResource("_content/BootstrapBlazor/lib/summernote/summernote-lite.min.css");
            ...
            // AddScriptResource("_content/BootstrapBlazor/lib/summernote/summernote-lite.min.js");
